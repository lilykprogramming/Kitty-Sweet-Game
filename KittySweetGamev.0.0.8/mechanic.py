...
#CUCUMBER
list_cucumber = pygame.sprite.Group()
ADD_CUCUMBER = pygame.USEREVENT + 1
...
start_rect_info = start_image.get_rect()
start_rect_info.topleft = (HEIGHT, 700)
...
return_start_rect.topleft = (HEIGHT - 240 ,20)
...
try_again_rect.topleft = (HEIGHT - 1200, 700)
...
pause_rect.topleft = (HEIGHT - 240, 20)
...
con_game_rect.topleft = (HEIGHT - 1200,700)
...
current_image_rect.topleft = (HEIGHT- 330, 20)

current_image_rect_2 = current_image.get_rect()
current_image_rect_2.topleft = (HEIGHT - 240, 20)
...
info_rect.topleft = (HEIGHT - 420, 20)
