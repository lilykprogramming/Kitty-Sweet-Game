...
def show_settings_screen_function():
    ...
    while True:
        ...
        e.screen_game.blit(mechanic.sit_cat_image,(800,100))
        e.screen_game.blit(mechanic.start_image_info, mechanic.start_rect_info)
        e.screen_game.blit(mechanic.current_image, mechanic.current_image_rect_2)
...
def show_start_screen_function():
    ...
    #FONT
        ...
        font_total_scores = pygame.font.Font("primer/fonts/Aleo-Regular.ttf", 30)
    ...
    #TRANSFORM SCALE SIGNATURE_TEXT_IMAGE
        ...
        mechanic.cat_with_bubble_tea_image = pygame.transform.scale(mechanic.cat_with_bubble_tea_image, (500,400))
    #SCREEN BLIT
        e.screen_game.blit(text_total_scores, (1000, 120))
        e.screen_game.blit(mechanic.signature_text_image,(110,960))
        e.screen_game.blit(mechanic.cat_with_bubble_tea_image,(800,650))
        e.screen_game.blit(mechanic.sleep_cat_image,(400,-150))
        e.screen_game.blit(mechanic.sleep_bed_cat_image,(-50,400))
        font_result = pygame.font.Font("primer/fonts/Aleo-Regular.ttf", 30)
    ...
    #SCREEN BLIT
        e.screen_game.blit(text_result_1,(20,70))
